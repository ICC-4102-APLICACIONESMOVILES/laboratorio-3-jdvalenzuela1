...
/*
        mainListView = (ListView) view.findViewById(R.id.forms);

        String[] forms = new String[]{"Juande", "20/agosto/1993", "Jugos"};
...
*/
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                ArrayAdapter<Forms> adapter = new ArrayAdapter<Forms>(getActivity(),
                        android.R.layout.simple_list_item_1, android.R.id.text1, allObjects);
